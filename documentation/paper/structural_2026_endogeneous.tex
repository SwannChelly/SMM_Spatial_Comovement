...
Figure~\ref{fig:counterfactual_distance_region} shows what those rates produce once they are aggregated with each buyer's spending and integrated along the path. In motor vehicles a one-sided distribution of rates gives a one-sided displacement: 20 of the 22 buyers source further when $\hat T$ is equalised, by 65~km on average, close to three times the effect of trade costs, and not one buyer moves by less than 5~km. In aerospace the two directions very nearly cancel in the aggregate --- the average sourcing distance moves by 2~km and the median by 3 --- and yet 89\% of buyers move by more than 5~km, with exactly half moving each way. The near-zero aggregate is a cancellation of large individual movements, not an absence of movement. Buyers in Toulouse lose the advantage of their local suppliers and source further. Buyers in the Paris region, whose purchases were drawn towards distant hubs such as Toulouse, source more locally: in Roissy -- Sud Picardie the average euro travels 377~km under the estimated allocation and 332~km once comparative advantage is equalised, a fall of 12\%.
